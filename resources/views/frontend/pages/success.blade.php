                    ...
                    <div class="invoice-inner">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <p class="invoice-addr-1 mt-10">
                                            <strong>Invoice Numb:</strong> <strong
                                                class="text-brand">#{{ $orderHistory->inv_id }}</strong> <br />
                                            <strong>Invoice Data:</strong>
                                            {{ $orderHistory->created_at->toFormattedDateString() }}
                                        </p>
                                    </div>
                                    @php
                                    ...
                                    <div class="col-lg-4 offset-4">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                <strong class="text-brand">{{ $orderHistory->name }}
                                                    {{ $orderHistory->lastName }}</strong> <br />
                                                ...
                                                <abbr title="Email">Email: </abbr><a
                                                    href="mailto::{{ $orderHistory->email }}"
                                                    class="__cf_email__">{{ $orderHistory->email }}</a><br />
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @if ($orderHistory->payment_method == 1)
                                                <tr>
                                                    ...
                                                    <td class="text-right f-w-600">{{ $total }} {{ 'BDT' }}
                                                    </td>
                                                </tr>
                                        ...
                                        <p class="font-sm">
                                            ...
                                            @elseif ($orderHistory->payment_method == 2)
                                                ...
                                                <strong>Transaction Id: <u
                                                        class="text-brand">{{ $orderHistory->transaction_id }}</u></strong>
                                            @endif
                                        </p>
                                    </div>
                                    @if ($orderHistory->payment_method == 1)
                        ...
                        <div class="invoice-btn-section clearfix d-print-none">
                            <a href="javascript:window.print()" class="btn btn-lg btn-custom btn-print hover-up"> <img
                                    src="{{ asset('frontend/assets/imgs/theme/icons/icon-print.svg') }}" alt="" />
                                Print </a>

                            ...
                            <div class="col-lg-6">
                                <div class="pl-25">
                                    ...
                                    <p class="mb-50">Ius ferri velit sanctus cu, sed at soleat accusata. Dictas prompta et
                                        ...
                                        Nullam quis ante Etiam sit amet orci eget. Quis commodo odio aenean
                                        sed adipiscing. Turpis massa tincidunt dui ut ornare lectus. Auctor elit sed
                                        vulputate mi sit amet. Commodo consequat. Duis aute irure dolor in reprehenderit in
                                        voluptate id est laborum.</p>
                                    <div class="carausel-3-columns-cover position-relative">
                                        <div id="carausel-3-columns-arrows"></div>
                                        <div class="carausel-3-columns" id="carausel-3-columns">
                                            <img src="{{ asset('frontend/assets/imgs/page/about-2.png') }}"
                                                alt="" />
                                            <img src="{{ asset('frontend/assets/imgs/page/about-3.png') }}"
                                                alt="" />
                                            <img src="{{ asset('frontend/assets/imgs/page/about-4.png') }}"
                                                alt="" />
                                            <img src="{{ asset('frontend/assets/imgs/page/about-2.png') }}"
                                                alt="" />
                                        </div>
                        ...
                        <section class="row align-items-center mb-50">
                            <div class="row mb-50 align-items-center">
                                <div class="col-lg-7 pr-30">
                                    <img src="{{ asset('frontend/assets/imgs/page/about-5.png') }}" alt=""
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-card">
                                                <img src="{{ asset('frontend/assets/imgs/page/about-6.png') }}"
                                                    alt="" />
                                                <div class="content text-center">
                                                    ...
                                                    <div class="social-network mt-20">
                                                        <a href="#"><img
                                                                src="{{ asset('frontend/assets/imgs/theme/icons/icon-facebook-brand.svg') }}"
                                                                alt="" /></a>
                                                        <a href="#"><img
                                                                src="{{ asset('frontend/assets/imgs/theme/icons/icon-twitter-brand.svg') }}"
                                                                alt="" /></a>
                                                        <a href="#"><img
                                                                src="{{ asset('frontend/assets/imgs/theme/icons/icon-instagram-brand.svg') }}"
                                                                alt="" /></a>
                                                        <a href="#"><img
                                                                src="{{ asset('frontend/assets/imgs/theme/icons/icon-youtube-brand.svg') }}"
                                                                alt="" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-card">
                                                <img src="{{ asset('frontend/assets/imgs/page/about-8.png') }}"
                                                    alt="" />
                                                <div class="content text-center">

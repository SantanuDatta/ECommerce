                    ...
                    <div class="invoice-inner">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <p class="invoice-addr-1 mt-10">
                                            <strong>Invoice Numb:</strong> <strong
                                                class="text-brand">#{{ $inv->inv_id }}</strong> <br />
                                    ...
                                    <div class="col-lg-4 offset-4">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                <strong class="text-brand">{{ $inv->name }} {{ $inv->lastName }}</strong>
                                                <br />
                                                {{ $inv->address_1 }}
                                                {{ $inv->address_2 }}<br />
                                                <abbr title="Phone">Phone:</abbr> {{ $inv->phone }}<br />
                                                <abbr title="Email">Email: </abbr><a href="mailto::{{ $inv->email }}"
                                                    class="__cf_email__">{{ $inv->email }}</a><br />
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach (App\Models\Cart::orderBy('id', 'asc')->where('order_id', $inv->id)->get() as $item)
                                                <tr>
                                                    <td>
                                                        <div class="item-desc-1">
                                                            ...
                                                            @if ($inv->status == 3 && Auth::check())
                                                                @if (is_null(App\Models\ProductReview::where('user_id', Auth::user()->id)->where('product_id', $item->product_id)->first()))
                                                                    <span><a href="" data-bs-toggle="modal"
                                                                            data-bs-target="#productReview-{{ $item->product_id }}">Review
                                                                            This Product</a></span>
                                                                @else
                                                                    <span><a href="" data-bs-toggle="modal"
                                                                            data-bs-target="#updateReview-{{ $item->product_id }}">Update
                                                                            This Product Review</a></span>
                                                                @endif
                                                            @endif
                                                            <!--Review Modal -->
                                                            <div class="modal fade"
                                                                id="productReview-{{ $item->product_id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('product.review') }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <ul class="rate-area">
                                                                                        <input type="radio"
                                                                                            id="5-star-{{ $item->product_id }}"
                                                                                            name="rating" value="5" />
                                                                                        <label
                                                                                            for="5-star-{{ $item->product_id }}"
                                                                                            title="Amazing">5 stars</label>
                                                                                        <input type="radio"
                                                                                            id="4-star-{{ $item->product_id }}"
                                                                                            name="rating" value="4" />
                                                                                        <label
                                                                                            for="4-star-{{ $item->product_id }}"
                                                                                            title="Good">4 stars</label>
                                                                                        <input type="radio"
                                                                                            id="3-star-{{ $item->product_id }}"
                                                                                            name="rating" value="3" />
                                                                                        <label
                                                                                            for="3-star-{{ $item->product_id }}"
                                                                                            title="Average">3 stars</label>
                                                                                        <input type="radio"
                                                                                            id="2-star-{{ $item->product_id }}"
                                                                                            name="rating" value="2" />
                                                                                        <label
                                                                                            for="2-star-{{ $item->product_id }}"
                                                                                            title="Not Good">2 stars</label>
                                                                                        <input type="radio"
                                                                                            id="1-star-{{ $item->product_id }}"
                                                                                            name="rating" value="1" />
                                                                                        <label
                                                                                            for="1-star-{{ $item->product_id }}"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <input type="submit" class="btn btn-primary"
                                                                                name="review" value="Review Product">
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            @foreach (App\Models\ProductReview::where('user_id', Auth::user()->id)->where('product_id', $item->product->id)->get() as $review)
                                                                <div class="modal fade"
                                                                    id="updateReview-{{ $item->product_id }}"
                                                                    tabindex="-1"
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form
                                                                                    action="{{ route('update.review', $review->id) }}"
                                                                                    method="POST">
                                                                                    @csrf
                                                                                    <div class="form-group">
                                                                                        <label for="">Review
                                                                                        ...
                                                                                        <ul class="rate-area">
                                                                                            <input type="radio"
                                                                                                id="5-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                name="rating"
                                                                                                value="5"@if ($review->rating == 5) checked @endif />
                                                                                            <label
                                                                                                for="5-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                title="Amazing">5
                                                                                                stars</label>
                                                                                            <input type="radio"
                                                                                                id="4-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                name="rating"
                                                                                                value="4"@if ($review->rating == 4) checked @endif />
                                                                                            <label
                                                                                                for="4-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                title="Good">4
                                                                                                stars</label>
                                                                                            <input type="radio"
                                                                                                id="3-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                name="rating"
                                                                                                value="3"@if ($review->rating == 3) checked @endif />
                                                                                            <label
                                                                                                for="3-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                title="Average">3
                                                                                                stars</label>
                                                                                            <input type="radio"
                                                                                                id="2-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                name="rating"
                                                                                                value="2"@if ($review->rating == 2) checked @endif />
                                                                                            <label
                                                                                                for="2-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                title="Not Good">2
                                                                                                stars</label>
                                                                                            <input type="radio"
                                                                                                id="1-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                name="rating"
                                                                                                value="1"@if ($review->rating == 1) checked @endif />
                                                                                            <label
                                                                                                for="1-star-{{ $item->product_id }}-review-{{ $review->id }}"
                                                                                                title="Bad">1
                                                                                                star</label>
                                                                                        </ul>
                                                                                    </div>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <input type="submit"
                                                                                    class="btn btn-primary" name="review"
                                                    ...
                                                    <td class="text-center">{{ $item->unit_price }} {{ __('BDT') }}
                                                    </td>
                                            ...
                                            @if ($inv->payment_method == 1)
                                                <tr>
                                                    ...
                                                    <td class="text-right f-w-600">{{ $total }}
                                                        {{ 'BDT' }}</td>
                                                </tr>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="font-sm">
                                            ...
                                            @elseif ($inv->payment_method == 2)
                                                ...
                                                <strong>Transaction Id: <u
                                                        class="text-brand">{{ $inv->transaction_id }}</u></strong>
                                            @endif
                                        </p>
                                    </div>
                                    @if ($inv->payment_method == 1)
                        ...
                        <div class="invoice-btn-section clearfix d-print-none">
                            <a href="javascript:window.print()" class="btn btn-lg btn-custom btn-print hover-up"> <img
                                    src="{{ asset('frontend/assets/imgs/theme/icons/icon-print.svg') }}"
                                    alt="" /> Print </a>

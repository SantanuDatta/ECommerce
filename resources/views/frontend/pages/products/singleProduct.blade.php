                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                <div class="detail-gallery">
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        @foreach ($prDetails->images as $image)
                                            <div><img src="{{ asset('backend/img/products/' . $image->image) }}"
                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="font-xs">
                                        <ul class="mr-50 float-start">
                                            <li class="mb-5">{{ __('Type:') }} <span class="text-brand">
                                                    @if ($prDetails->product_type == 0)
                                                        {{ __('Physical') }}
                                            ...
                                            <li class="mb-5">{{ __('MFG:') }} <span class="text-brand">
                                                    {{ $prDetails->mfg_date ?? 'N/A' }}</span></li>
                                            <li>{{ __('Expire:') }} <span class="text-brand">
                                                    {{ $prDetails->exp_date ?? 'N/A' }}</span></li>
                                        </ul>
                                        <ul class="float-start">
                                            <li class="mb-5">{{ __('SKU:') }} <a
                                                    href="#">{{ $prDetails->sku_code ?? 'N/A' }}</a></li>
                                            <li class="mb-5">{{ __('Tags:') }} <a href="#"
                                                    rel="tag">{{ $prDetails->product_tags ?? 'N/A' }}</a></li>
                                            <li>{{ __('Stock:') }} <span
                                                    class="in-stock text-brand ml-5">{{ $prDetails->quantity }}
                                                    {{ __('In Stock') }}</span></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <ul class="nav nav-tabs text-uppercase">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab"
                                            href="#Additional-info">{{ __('Additional info') }}</a>
                                    </li>
                                    {{-- <li class="nav-item">
                                        ...
                                        <div class="comments-area">
                                            <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="user justify-content-between d-flex">
                                                                    <div class="thumb text-center">
                                                                        <img src="{{ asset('backend/img/Default.png') }}"
                                                                            alt="" /><br>
                                                                        <a href="#"
                                                                    ...
                                                                    <div class="desc">
                                                                        <div class="d-flex justify-content-between mb-10">
                                                                            <div class="d-flex align-items-center">
                                                                                <span
                                                                                    class="font-xs text-muted">{{ $review->created_at->toDayDateTimeString() }}
                                                                                </span>
                                                                            </div>
                                                                            ...
                                                                            <div class="d-inline-block">
                                                                                <form action="">
                                                                                    <ul class="shop-rate-area">
                                                                                        <input type="radio"
                                                                                            id="5-star" name="rating"
                                                                                            value="5"
                                                                                            @if ($review->rating == 5) checked @endif />
                                                                                        <label for="5-star"
                                                                                            title="Amazing">5 stars</label>
                                                                                        <input type="radio"
                                                                                            id="4-star" name="rating"
                                                                                            value="4"
                                                                                            @if ($review->rating == 4) checked @endif />
                                                                                        <label for="4-star"
                                                                                            title="Good">4 stars</label>
                                                                                        <input type="radio"
                                                                                            id="3-star" name="rating"
                                                                                            value="3"
                                                                                            @if ($review->rating == 3) checked @endif />
                                                                                        <label for="3-star"
                                                                                            title="Average">3 stars</label>
                                                                                        <input type="radio"
                                                                                            id="2-star" name="rating"
                                                                                            value="2"
                                                                                            @if ($review->rating == 2) checked @endif />
                                                                                        <label for="2-star"
                                                                                            title="Not Good">2
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="d-flex mb-30">
                                                        <div class=" d-inline-block mr-15">
                                                            <ul class="customer-rate-area">
                                                                <input type="radio" id="5-star" name="rating"
                                                                    value="5"
                                                                    @if ($review->rating == 5) checked @endif />
                                                                <label for="5-star" title="Amazing">5 stars</label>
                                                    ...
                                                    @php
                                                        $totalFive = DB::table('product_reviews')
                                                            ->where('rating', 5)
                                                            ->count();
                                                        $totalFour = DB::table('product_reviews')
                                                            ->where('rating', 4)
                                                            ->count();
                                                        $totalThree = DB::table('product_reviews')
                                                            ->where('rating', 3)
                                                            ->count();
                                                        $totalTwo = DB::table('product_reviews')
                                                            ->where('rating', 2)
                                                            ->count();
                                                        $totalOne = DB::table('product_reviews')
                                                            ->where('rating', 1)
                                                            ->count();

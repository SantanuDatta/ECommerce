                        ...
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            @foreach ($settings as $setting)
                                <div class="logo mb-30">
                                    <a href="{{ route('home') }}" class="mb-15"><img src="{{ asset('backend/img/settings/logo/'. $setting->logo) }}" alt="logo" /></a>
                                    <p class="font-lg text-heading">Awesome grocery store website template</p>
                                </div>
                                <ul class="contact-infor">
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg')  }}" alt="" /><strong>Address: </strong> <span>{{ $setting->address ?? 'N/A' }}</span></li>
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')  }}" alt="" /><strong>Call Us:</strong> <span>{{ $setting->phone_no ?? 'N/A' }}</span></li>
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg')  }}" alt="" /><strong>Email:</strong> <span><a href="mailto::{{ $setting->email }}" class="__cf_email__">{{ $setting->email ?? 'N/A'}}</a></span></li>
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg')  }}" alt="" /><strong>Hours:</strong> <span>{{ $setting->business_hours ?? 'N/A' }}</span></li>
                                </ul>
                            @endforeach
                        </div>
                    </div>

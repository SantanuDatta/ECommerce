    <!-- Quick view -->
    <div class="modal fade custom-modal" id="quickViewModal-{{ $prDetails->id }}" tabindex="-1"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><a href="shop-product-right.html"
                                        class="text-heading">{{ $prDetails->name }}</a></h3>
                                ...
                                <div class="font-xs">
                                    <ul>
                                        <li class="mb-5">Brand: <span
                                                class="text-brand">{{ $prDetails->brand->name ?? 'N/A' }}</span></li>
                                        <li class="mb-5">MFG:<span
                                                class="text-brand">{{ $prDetails->mfg_date ?? 'N/A' }}</span></li>
                                        <li class="mb-5">EXP:<span
                                                class="text-brand">{{ $prDetails->exp_date ?? 'N/A' }}</span></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Detail Info -->

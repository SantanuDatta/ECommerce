    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="{{ route('admin.dashboard') }}"><span>[</span>bracket <i>plus</i><span>]</span></a></div>
    ...
    <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
            ...
            @if (Route::is('brand.manage') || Route::is('brand.create') || Route::is('brand.edit') || Route::is('brand.softdelete'))
                active
            @endif
            ">
            ...
            <ul class="br-menu-sub">
                ...
                <li class="sub-item"><a href="{{ route('brand.softdelete') }}" class="sub-link @if (Route::is('brand.softdelete'))
                    active
                @endif ">Soft Deleted Brands</a></li>
            </ul>
        </li>

        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub
            @if (Route::is('category.manage') || Route::is('category.create') || Route::is('category.edit') || Route::is('category.softdelete'))
                active
            @endif
            ">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('category.create') }}" class="sub-link @if (Route::is('category.create')) active @endif ">Add New Category</a></li>
                <li class="sub-item"><a href="{{ route('category.manage') }}" class="sub-link @if (Route::is('category.manage')) active @endif ">Manage All Categories</a></li>
                <li class="sub-item"><a href="{{ route('category.softdelete') }}" class="sub-link @if (Route::is('category.softdelete')) active @endif ">Soft Deleted Categories</a></li>
            </ul>
        </li>
        ...
        {{-- <li class="br-menu-item">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="card-dashboard.html" class="sub-link">Add New Category</a></li>
                <li class="sub-item"><a href="card-social.html" class="sub-link">Manage All Categories</a></li>
            </ul>
        </li> --}}
        
        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub
            @if (Route::is('product.manage') || Route::is('product.create') || Route::is('product.edit') || Route::is('product.softdelete'))
                active
            @endif
            ">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('product.create') }}" class="sub-link @if (Route::is('product.create')) active @endif">Add New Product</a></li>
                <li class="sub-item"><a href="{{ route('product.manage') }}" class="sub-link @if (Route::is('product.manage')) active @endif">Manage All Products</a></li>
                <li class="sub-item"><a href="{{ route('product.softdelete') }}" class="sub-link @if (Route::is('product.softdelete')) active @endif">Soft Deleted Products</a></li>
            </ul>
        </li>
        ...
        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub
            @if (Route::is('country.manage') || Route::is('country.create') || Route::is('country.edit'))
            active
            @endif
            ">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('country.create') }}" class="sub-link @if (Route::is('country.create')) active @endif ">Add New Country</a></li>
                <li class="sub-item"><a href="{{ route('country.manage') }}" class="sub-link @if (Route::is('country.manage')) active @endif ">Manage All Countries</a></li>
            </ul>
        </li>
        {{-- Division --}}
        <li class="br-menu-item">
        ...
        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub
            @if (Route::is('slider.manage') || Route::is('slider.create') || Route::is('slider.edit'))
            active
            @endif
            ">
                <i class="menu-item-icon icon ion-ios-settings tx-20"></i>
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('slider.create') }}" class="sub-link @if (Route::is('slider.create')) active @endif ">Add New Slider</a></li>
                <li class="sub-item"><a href="{{ route('slider.manage') }}" class="sub-link @if (Route::is('slider.manage')) active @endif ">Manage All Sliders</a></li>
            </ul>
        </li>
        ...
        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub
            @if (Route::is('flash.manage') || Route::is('flash.create') || Route::is('flash.edit'))
            active
            @endif
            ">
                <i class="menu-item-icon icon ion-ios-settings tx-20"></i>
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('flash.create') }}" class="sub-link @if (Route::is('flash.create')) active @endif ">Add New Flash</a></li>
                <li class="sub-item"><a href="{{ route('flash.manage') }}" class="sub-link @if (Route::is('flash.manage')) active @endif ">Manage All Flashes</a></li>
            </ul>
        </li>

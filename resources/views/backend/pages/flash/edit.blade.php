                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" name="name" value="{{ $flash->name }}" >
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-dark" id="">
                                            ...
                                            <option value="1" @if($flash->status == 1) selected @endif >Active</option>
                                            <option value="0" @if($flash->status == 0) selected @endif >Inactive</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" name="editFlash" class="btn btn-teal float-right">Update Flash</button>
                                    </div>
                                </div>
                            </div>
                        </form>

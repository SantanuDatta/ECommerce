                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_parent" class="form-control form-control-dark" id="">
                                            @if ($category->is_parent == 0)
                                                <option value="0" @if ($category->is_parent == 0) selected hidden @endif>'{{ $category->name }}' Is Already A Parent Category</option>
                                            @else
                                                <option value="0" >Make '{{ $category->name }}' A Parent Category</option>
                                            @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-dark" id="">
                                            ...
                                            <option value="2" @if($category->status == 2) selected @endif hidden >Soft Deleted</option>
                                        </select>
                                    </div>
                                    <div class="form-group">

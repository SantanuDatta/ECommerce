                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group action-bar" role="group">
                                                        ...
                                                        <a href="" data-toggle="modal" data-target="#fulldelete-{{ $pCat->id }}"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                    <!-- View Modal -->
                                                    ...
                                                    <!-- Full Delete Modal -->
                                                    <div class="modal fade effect-scale modal-dark" id="fulldelete-{{ $pCat->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
                                                            <h5 class="modal-title" id="deleteModalLabel">Full Delete Category</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
                                                            <form action="{{ route('category.fulldelete', $pCat->id) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" name="status" class="btn btn-danger btn-sm" >Full Delete</button>
                                                            </form>
                                                            </div>
                                                        </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group action-bar" role="group">
                                                        ...
                                                        <a href="" data-toggle="modal" data-target="#fulldelete-{{ $childCat->id }}"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                    <!-- View Modal -->
                                                    ...
                                                    <!-- Full Delete Modal -->
                                                    <div class="modal fade effect-scale modal-dark" id="fulldelete-{{ $childCat->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
                                                            <h5 class="modal-title" id="deleteModalLabel">Full Delete Category</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
                                                            <form action="{{ route('category.fulldelete', $childCat->id) }}" method="POST">
                                                            @csrf

                                                    ...
                                                    <div class="modal fade effect-scale modal-dark"
                                                        ...
                                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                                            <div class="modal-content bd-0">
                                                                ...
                                                                <div class="modal-body pd-20">
                                                                    <p class="mg-b-5">
                                                                        Category Will Be Removed But You Can Activate It
                                                                        Back
                                                                    </p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary btn-sm"
                                                                        data-dismiss="modal">Close</button>
                                                                    <form
                                                                        action="{{ route('category.destroy', $pCat->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                ...
                                                @if ($childCat->status == 0 || $childCat->status == 1)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                &#8627; <span
                                                                    class="badge badge-info">{{ $pCat->name }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            <div class="modal fade effect-scale modal-dark"
                                                                ...
                                                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                                                    <div class="modal-content bd-0">
                                                                        ...
                                                                        <div class="modal-body pd-20">
                                                                            <p class="mg-b-5">
                                                                                Category Will Be Removed But You Can
                                                                                Activate It Back
                                                                            </p>
                                                                        </div>
                                                                        <div class="modal-footer">

                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" name="name" placeholder="Please Input Division Name">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="addDivision" class="btn btn-teal float-right">Add Division</button>
                                    </div>
                                </div>

                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    <a href="{{ route('division.edit', $division->id) }}"><i class="fas fa-edit"></i></a>
                                                    <a href="" data-toggle="modal" data-target="#deleteDivison-{{ $division->id }}"><i class="fas fa-trash"></i></a>
                                                </div>
                                                
                                                <!-- Delete Modal -->
                                                <div class="modal fade effect-scale modal-dark" id="deleteDivison-{{ $division->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                    <div class="modal-content bd-0">
                                                        <div class="modal-header pd-x-20">
                                                        <h5 class="modal-title" id="deleteModalLabel">Delete Divison</h5>
                                                        ...
                                                        @csrf
                                                        <button type="submit" name="status" class="btn btn-danger btn-sm" >Delete Divison</button>
                                                        </form>
                                                        </div>
                                                    </div>
                                                    </div>

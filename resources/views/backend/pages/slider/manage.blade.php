                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (is_null($slider->image))
                                                    <img src="{{ asset('backend/img/sliders/Default.jpg') }}" alt="" class="img-fluid table-sq-image">
                                                @else
                                                    <img src="{{ asset('backend/img/sliders/' . $slider->image) }}" class="img-fluid table-sq-image">
                                                @endif
                                            </td>
                                            <td>{{ $slider->name }}</td>
                                            <td><p>{!! $slider->short_desc !!}</p></td>
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    ...
                                                    <a href="" data-toggle="modal" data-target="#deleteSlider-{{ $slider->id }}"><i class="fas fa-trash"></i></a>
                                                </div>
                                                
                                                <!-- Delete Modal -->
                                                <div class="modal fade effect-scale modal-dark" id="deleteSlider-{{ $slider->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content bd-0">
                                                        ...
                                                        @csrf
                                                        <button type="submit" name="status" class="btn btn-danger btn-sm" >Delete Slider</button>
                                                        </form>
                                                        </div>
                                                    </div>
                                                    </div>

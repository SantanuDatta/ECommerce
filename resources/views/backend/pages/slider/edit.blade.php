                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" name="name"
                                            placeholder="Please Input Slider Name" value="{{ $slider->name }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label custom-file-label-primary">Upload New
                                                Image</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="editSlider" class="btn btn-teal float-right">Update
                                            Slider</button>
                                    </div>
                                </div>

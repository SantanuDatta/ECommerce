                            ...
                            <div class="row">
                                {{-- @if ($errors->any())
                                    <div class="col-lg-12">
                                        <div class="errors alert alert-danger">
                                            <strong>There Are Errors In The Form Please Revise:</strong>
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                                    <strong><li style="list-style: disclosure-closed;">{{ $error }}</li></strong>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" name="name" placeholder="Please Input Brand Name" value="{{ $brand->name }}">
                                        @error('name')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-dark" id="">
                                            ...
                                            <option value="0" @if($brand->status == 0) selected @endif >Active</option>
                                            <option value="1" @if($brand->status == 1) selected @endif >Inactive</option>
                                            <option value="2" @if($brand->status == 2) selected @endif hidden >Soft Deleted</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" name="editBrand" class="btn btn-teal float-right">Edit Brand</button>
                                    </div>
                                </div>

                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" id="name" name="name" placeholder="Please Input Brand Name" value="{{ old('name') }}" >
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="short_desc" name="description" class="form-control form-control-dark" placeholder="Write A Short Description">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="addBrand" class="btn btn-teal float-right">Add Brand</button>
                                    </div>
                                </div>

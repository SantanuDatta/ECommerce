                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (is_null($brand->image))
                                                    <img src="{{ asset('backend/img/brands/Default.png') }}" alt=""
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    <a href="" data-toggle="modal"
                                                        data-target="#description-{{ $brand->id }}"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="{{ route('brand.edit', $brand->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="" data-toggle="modal"
                                                        data-target="#fulldelete-{{ $brand->id }}"><i
                                                            class="fas fa-trash"></i></a>
                                                </div>
                                                <!-- View Modal -->
                                                <div class="modal fade effect-scale modal-dark"
                                                    id="description-{{ $brand->id }}" tabindex="-1"
                                                    aria-labelledby="viewModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
                                                                <h5 class="modal-title" id="viewModalLabel">Brand Descripton
                                                                </h5>
                                                ...
                                                <!-- Full Delete Modal -->
                                                <div class="modal fade effect-scale modal-dark"
                                                    id="fulldelete-{{ $brand->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                                        <div class="modal-content bd-0">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary btn-sm"
                                                                    data-dismiss="modal">Close</button>
                                                                <form action="{{ route('brand.fulldelete', $brand->id) }}"
                                                                    method="POST">
                                                                    @csrf

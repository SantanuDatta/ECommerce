                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-dark" name="name" placeholder="Please Input Country Name" value="{{ $country->name }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="">Select Priority No.</label>
                                        <input type="number" class="form-control form-control-dark" name="priority" value="{{ $country->priority }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="editCountry" class="btn btn-teal float-right">Edit Country</button>
                                    </div>
                                </div>

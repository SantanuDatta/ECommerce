            ...
            <div class="col-lg-8">
                ...
                <div class="card bd-gray-400 pd-25 mg-t-20">
                    <div class="d-md-flex justify-content-between">
                        <div>
                            <h6 class="tx-13 tx-uppercase tx-white tx-semibold tx-spacing-1">How Engaged Our Users Daily
                            </h6>
                            <p>Past 30 Days — Last Updated Oct 14, 2017</p>
                        </div>
                        <div class="wd-200">
                ...
                <div class="card bd-gray-400 overflow-hidden">
                    ...
                    <div class="bg-teal pd-x-25 pd-b-25 d-flex justify-content-between">
                        <div class="tx-center">
                            ...
                            <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase mg-b-0 tx-white-8">Total Space
                            </p>
                        </div>
                        <div class="tx-center">

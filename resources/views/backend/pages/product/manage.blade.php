                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col right text-right">
                                    <a href="{{ route('product.softdelete') }}" class="tx-white">Soft Deleted Products <i class="ion-ios-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    ...
                                                    <a href="" data-toggle="modal" data-target="#softdelete-{{ $product->id }}"><i class="fas fa-trash"></i></a>
                                                </div>
                                                <!-- View Modal -->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content bd-0">
                                ...
                                <table class="table table-striped table-hover table-bordered list-table">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-muted">@if ($product->status == 0)
                                                <span>Inactive</span>
                                            @elseif ($product->status == 1)
                                                <span">Active</span>
                                            @endif
                ...
                <a href="{{ route('product.edit', $product->id) }}" class="btn btn-teal btn-sm">Update Product</a>
                                                ...
                                                <!-- Soft Delete Modal -->
                                                <div class="modal fade effect-scale modal-dark" id="softdelete-{{ $product->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">

...
@section('body-content')
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col right text-right">
                                    <a href="{{ route('product.manage') }}" class="tx-white"><i
                                            class="ion-ios-arrow-left"></i> Manage All Products</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group action-bar" role="group">
                                                    ...
                                                    <a href="" data-toggle="modal"
                                                        data-target="#fulldelete-{{ $product->id }}"><i
                                                        ...
                                                        <div class="modal-content bd-0">
                                                            <div class="modal-header pd-x-20">
                                                                <h5 class="modal-title" id="viewModalLabel"><strong
                                                                        ...
                                                                        class="text-muted">{{ $product->name }}</span></h5>
    ...
    <!-- Full Delete Modal -->
    <div class="modal fade effect-scale modal-dark" id="fulldelete-{{ $product->id }}" tabindex="-1"
